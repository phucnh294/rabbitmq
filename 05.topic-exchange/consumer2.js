...
async function consumer2 (queueName){  
    try{
        //1. create connection
        ...
        await channel.bindQueue(queue, exchangeName, "*.Java"); // wildcard for all topic have 'Java'
        await channel.bindQueue(queue, exchangeName, "everything.#"); // wildcard for all topic have 'C#'

        console.log(`waiting message in ${queue} with topic pattern '*.Java' or 'everyhing.*' `);
